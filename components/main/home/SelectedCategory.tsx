...
const SelectedCategory: React.FC<SelectedCategoryProps> = ({ selectedCategory, categories, goBackHandler }) => {
    const { text, background, backgroundDarker, tint, tintLowOpacity } = useColors()

    console.log(categories);

    return (
        <View style={categories.length !== 0 ? styles.selectedCategoryContainer : styles.lastCategoryContainer}>
            {selectedCategory ?
                <>
                    ...
                    {categories.length !== 0 ?
                        ...
                        >
                            ...
                            <TouchableOpacity onPress={goBackHandler} style={[styles.remove, { backgroundColor: backgroundDarker }]}>
                        ...
                        <View style={[styles.lastCategory, { backgroundColor: background, shadowColor: text }]}>
                            ...
                            <TouchableOpacity onPress={goBackHandler} style={[styles.removeLast, { backgroundColor: tint }]}>
